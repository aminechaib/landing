...
const ar: Record<string, any> = {
  ...
  favorites: {
    ...
    all: "الكل",
    empty: "لا توجد منتجات مطابقة — جرّب كلمة بحث أخرى.",
  ...
  track: {
    title: "تتبع طلبك",
    description: "أدخل رقم الطلب ورقم الهاتف لعرض حالة طلبك.",
    orderNumber: "رقم الطلب",
    phone: "رقم الهاتف",
    submit: "تتبع الطلب",
    searching: "جارٍ البحث…",
    notFound: "لم يتم العثور على الطلب. تأكد من رقم الطلب ورقم الهاتف.",
...
const en: Record<string, any> = {
  ...
  favorites: {
    ...
    all: "All",
    empty: "No matching products — try a different search.",
  ...
  track: {
    ...
    description: "Enter your order number and phone number to see your order status.",
    orderNumber: "Order number",
    phone: "Phone number",
    submit: "Track order",
    searching: "Searching…",
    notFound: "Order not found. Please check your order number and phone number.",
