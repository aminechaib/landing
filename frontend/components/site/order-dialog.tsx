        ...
        {confirmation ? (
          ...
          <>
            <DialogHeader>
              ...
              <DialogDescription>
                Pay cash when your order arrives. No account needed.
              </DialogDescription>
            </DialogHeader>
                ...
                <div className="mt-2 flex items-center justify-between">
                  <div className="flex items-center rounded-lg border border-input bg-card">
                    <button
                      ...
                      className="flex size-8 items-center justify-center rounded-l-lg hover:bg-secondary disabled:opacity-40"
                      disabled={quantity <= 1}
                    >
                    ...
                    <button
                      ...
                      className="flex size-8 items-center justify-center rounded-r-lg hover:bg-secondary disabled:opacity-40"
            ...
            <form onSubmit={submit} className="space-y-4">
              ...
              <div className="space-y-1.5">
                ...
                <Textarea id="notes" rows={2} maxLength={2000} placeholder="Delivery instructions…" value={form.notes} onChange={(e) => set("notes", e.target.value)} />
              </div>
              ...
              <div className="flex items-start gap-3 rounded-xl border border-accent/40 bg-accent-soft/60 p-3">
                ...
                <div className="text-sm">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Inspect your order, then pay in cash to the courier.
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-1.5 rounded-xl border border-border p-4 text-sm">
                ...
                <Row label="Shipping" value={shippingCost > 0 ? formatMoney(shippingCost, product.currency) : "FREE"} accent={shippingCost === 0} />
                {codeValid && (
                  <Row label={`Discount ${promoPercent}% (${promoCode})`} value={`−${formatMoney(discount, product.currency)}`} accent />
                )}
                {!codeValid && (
              ...
              <p className="flex items-center justify-center gap-1.5 text-[11px] text-muted-foreground">
                <Truck className="size-3" /> We will contact you shortly to confirm delivery.
              </p>
            </form>
          </>
        )}
    ...
    <div className="py-4 text-center">
      ...
      <div className="mx-auto mt-6 max-w-xs space-y-2 rounded-xl border border-border bg-muted/40 p-4 text-sm">
        <div className="flex justify-between">
          ...
          <span className="font-semibold">#{confirmation.order_number}</span>
        </div>
        <div className="flex justify-between">
        ...
        <div className="flex justify-between border-t border-border pt-2">
          <span className="text-muted-foreground">Total due on delivery</span>
